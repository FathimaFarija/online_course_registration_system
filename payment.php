...
if(isset($_POST["submit"])){
  ...
  $query = "INSERT INTO payment VALUES('','$number','$amount','$name','$month','$year','$cvv')";
...
<div class="container">
    ...
    <form action="">
        <div class="inputBox">
            ...
            <input type="text" maxlength="16" class="card-number-input" name="number">
        </div>
        <div class="inputBox">
            <span>Payment Amount</span>
            <input type="number" maxlength="16" name="amount" >
        </div>
        <div class="inputBox">
            <span>card holder</span>
